...
//       videos: ['assets/video.mp4', 'assets/video2.mp4'],
//       news: [
//         {
//           title: "Agriculture",
//           content: `
//           Agriculture is the practice of cultivating plants and livestock for food, fiber, medicinal plants, and other products used to sustain and enhance human life. It is the backbone of many economies and a fundamental source of food security for billions of people around the world.
...
//           title: "Cricket",
//           content: `
//           Team India, officially known as the Indian National Cricket Team, represents India in international cricket. Here are some key points about Team India:
...
//   displayMedia(key: string) {
//     const media = this.mediaService.getMediaData(key);
...
//       });
//     } else {
//       console.error('Media not found for key:', key);
//     }
//   }
// }
...
export class ButtonComponent implements OnInit {
  ...
  constructor(private mediaService: MediaService, private mediaServiceapi: MediaServiceAPIService) {}

  ngOnInit() {
    this.mediaServiceapi.getMediaData().subscribe((responsedata: any) => {
      console.log(responsedata);
      this.media = responsedata;
    });
  }

  onClickTitle(data: any) {
    this.mediaService.openMediaDialog(data);
  }
}
